...
// Addition of Vrms/Temperature by: Matthew Wire (using code from mk2pvrouter (Mk2_RFdatalog_4) by Robin Emley).
// Addition of Wh import/export totals by Matthew wire based on http://openenergymonitor.org/emon/node/5309 (Dave Dixon)
      ...
      if (polarityOfLastSampleV != POSITIVE)
      {
        ...
        switch(sequenceCount)
        {
          ...
          case 20: 
            ...
            if (joules_CT1>=3600) {    // is >=3600 and <=-3600 to give a +-1 Wh dead band around zero to account for noise?
              tx_data.impwh_CT1 += joules_CT1 / 3600;
              joules_CT1 = (joules_CT1 - 3600) % 3600;
            }
            else if (joules_CT1<=-3600) {
              tx_data.expwh_CT1 += (-1*joules_CT1) / 3600;
              joules_CT1 = (joules_CT1 + 3600) % 3600;
            }
          ...
          case 40: 
            ...
            if (joules_CT2>=3600) {    // is >=3600 and <=-3600 to give a +-1 Wh dead band around zero to account for noise?
              tx_data.impwh_CT2 += joules_CT2 / 3600;
              joules_CT2 = (joules_CT2 - 3600) % 3600;
            }
            else if (joules_CT2<=-3600) {
              tx_data.expwh_CT2 += (-1*joules_CT2) / 3600;
              joules_CT2 = (joules_CT2 + 3600) % 3600;
            }
          ...
          case 60: 
            ...
            if (joules_CT3>=3600) {    // is >=3600 and <=-3600 to give a +-1 Wh dead band around zero to account for noise?
              tx_data.impwh_CT3 += joules_CT3 / 3600;
              joules_CT3 = (joules_CT3 - 3600) % 3600;
            }
            else if (joules_CT3<=-3600) {
              tx_data.expwh_CT3 += (-1*joules_CT3) / 3600;
              joules_CT3 = (joules_CT3 + 3600) % 3600;
            }
            ...
            Serial.print(':');
            Serial.print(tx_data.impwh_CT3);
            Serial.print(':');
            Serial.print(tx_data.expwh_CT3);
            break;
          case 100: 
            tx_data.msgNumber = msgNumber++;
  
            tx_data.temperature = readTemperature();
